...
export const SETTING_KEYS = [
  ...
  { key: "FORCE_JOIN_ENABLED",            group: "Force Join",  isSecret: false, placeholder: "true / false — require users to join channel(s) before bot delivers files" },
  { key: "FORCE_JOIN_RULE",                group: "Force Join",  isSecret: false, placeholder: "and (must join every channel) | or (must join at least one). Default: and" },
  { key: "FORCE_JOIN_CHANNEL",             group: "Force Join",  isSecret: false, placeholder: "Legacy single-channel: @your_channel or -1001234567890. Use the Force Join page for multi-channel rules." },
  { key: "FORCE_JOIN_CHANNEL_URL",         group: "Force Join",  isSecret: false, placeholder: "Legacy: https://t.me/your_channel (only used when no rows exist on the Force Join page)" },
  { key: "FORCE_JOIN_CHANNEL_TITLE",       group: "Force Join",  isSecret: false, placeholder: "Legacy: display name shown in the join prompt" },
