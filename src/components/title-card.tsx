...
export function TitleCard({ item }: { item: TitleCardData }) {
  return (
    <Link
      ...
      className="group relative block overflow-hidden rounded-lg sm:rounded-xl bg-surface shadow-card transition-all duration-300 active:scale-[0.98] md:hover:scale-[1.04] md:hover:z-10 md:hover:shadow-[0_20px_50px_-12px_oklch(0.62_0.24_18/0.4)] ring-1 ring-border/40 hover:ring-primary/40"
    >
